...
if __name__ == '__main__':
    j = Json("{'customers': [{'address': 'nagpur', 'id': 525, 'name': 'robin sharma'}, {'address': 'chennai', 'id': 526, 'name': 'alex pandian'}, {'address': 'kolkata', 'id': 527, 'name': 'saurabh mishra'}], 'market-share': True, 'profits': None}")
    print(Json.is_valid(j.text))
    print(j.type)
    j.write_file('customers_copy')